...
def backtest(stock_dict_list, log):
    ...
    for stock_list in stock_dict_list:
        ...
        for stock in stock_list:
            ...
            if ma_50 > ma_200 and num != 0 and sell:
...
def main():
    ...
    if num_graphs.lower() == "active":
        ...
        graph_moving_average_single(max_stock)
        return
    ...
    graph_moving_average(temp_dict_list)
